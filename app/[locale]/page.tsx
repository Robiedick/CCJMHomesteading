        ...
        <header className="border-b border-white/60 bg-white/70 backdrop-blur">
          <div className="mx-auto flex max-w-6xl flex-col gap-3 px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-stone-500">{dictionary.nav.tagline}</p>
            </div>
            <div className="flex flex-wrap items-center gap-3 text-sm">
              ...
              <Link
                href={`/${locale}#stories`}
                className="rounded-full border border-emerald-200 bg-white/70 px-4 py-2 font-medium text-emerald-700 transition hover:border-emerald-300 hover:bg-white"
              >
          ...
          <div className="mx-auto grid max-w-6xl gap-8 px-6 pb-12 pt-6 lg:grid-cols-[1.7fr_1fr]">
            <div className="rounded-3xl border border-white/70 bg-white/85 p-10 shadow-xl shadow-emerald-100/40">
              <h1 className="text-4xl font-semibold leading-tight text-stone-900 sm:text-5xl">
                {dictionary.hero.title}
              </h1>
              <p className="mt-6 text-lg text-stone-600">{dictionary.hero.description}</p>
